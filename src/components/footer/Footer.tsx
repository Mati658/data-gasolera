        ...
        <div className='footer-columna'>
          ...
          <div className='footer-item gap'>
            <a href="https://x.com/DataGasolera?t=MNUV9xo2SVOFFb79P9b2xw&s=09" target='_blank'>
              <svg role="img" viewBox="0 0 24 24" width={40} height={40} xmlns="http://www.w3.org/2000/svg" id="X--Streamline-Simple-Icons"><desc></desc><title></title><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8 -7.584 -6.638 7.584H0.474l8.6 -9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" fill="#ffffff" stroke-width="1"></path></svg>
            </a>
            ...
            <a href="https://www.tiktok.com/@data_gasolera?_t=ZM-8vn4QLSvSmU&_r=1" target='_blank'>
              <svg viewBox="0 0 24 24"  width={40} height={40} fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="1.56"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M20 7.50414C18.5333 7.56942 15.52 6.75998 15.2 3H12.4V13.9666C12.4 17.0999 9.93253 18.4412 8.289 17.2507C6.20169 15.7389 7.60003 12.5958 10.2 12.9874V9.6583C8.20003 9.6583 4 10.4416 4 15.3374C4 21.6041 10.8146 21.4083 12.4 20.5824C14.9798 19.2385 15.6 17.7827 15.6 14.5541C15.6 11.6166 15.6 9.85413 15.6 9.0708C16.2667 9.39719 18.08 10.0891 20 10.2458" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>            
            </a>
